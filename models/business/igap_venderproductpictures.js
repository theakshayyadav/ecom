...
class Business {
    ...
    save=()=>{
        ...
        if(this.id==0){
            this.query = "INSERT INTO igap_venderproductpictures(id, title, productid, picpath, srno )  ";
    ...
    get=()=>{
        this.query = "SELECT * FROM igap_venderproductpictures WHERE id = "+this.id;
        console.log(this.query);
        return new Promise((resolve, reject)=>{
            this.db.query(this.query, (err, result)=>{
                this.db.close();
    ...
    list=()=>{
        this.query =  "SELECT * FROM igap_venderproductpictures ";
        console.log(this.query);
        return new Promise((resolve, reject)=>{
            this.db.query(this.query, (err, result)=>{
                this.db.close();
    ...
    delete=()=>{
        this.query = "DELETE FROM igap_venderproductpictures  WHERE id = "+this.id+"";
